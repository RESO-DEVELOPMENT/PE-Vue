<template>
  <div>
      ...
      <div class="">
        <div class="bg-transparent custom-action-card">
          <el-row>
            ...
            <el-row type="flex" :gutter="10" justify="space-between" class="mt-3">
              <el-col :span="12">
                <el-form-item :prop="'productAction.value'" label="Discount value (%)">
                  <el-input-number
                    :min="0"
                    :max="100"
    ...
    <!-- END Percentage -->
    <!-- START Unit -->
    <el-row v-show="actionForm.discountType == '3'">
      <div class="">
        <div class="bg-transparent custom-action-card">
          <el-col :span="24"><h2 class="custom-label-action">Action for item</h2></el-col>
          <el-row>
    ...
    <!-- END Unit -->
    <!-- START fixed price -->
    <el-row v-show="actionForm.discountType == '5'">
      <div class="">
        <div class="bg-transparent custom-action-card">
          <el-col :span="24"><h2 class="custom-label-action">Action for item</h2></el-col>
          <el-col :span="24" class="mb-3">
    ...
    <!-- END fixed price -->
    <!-- START ladder -->
    <el-row v-show="actionForm.discountType == '6'">
      <div class="">
    ...
    <!-- END ladder -->
    <!-- START bundle -->
    <el-row v-show="actionForm.discountType == '7'">
      <div class="">
        <div class="custom-action-card">
          <el-col :span="24">
            <h2 class="custom-label-action">Action for item</h2>
...
export default {
  ...
  name: "product-action-update",
  methods: {
    handleChangeAction(val) {
      this.$emit("handle-change-action", val);
    },
    addProductCode() {
