...
import PromotionsTable from "./Promotion/PromotionTable.vue";
...
export default {
  ...
  methods: {
    addPromotion() {
      ...
      this.$router.push("/campaign/promotion/wizard");
    },
  },
};
</script>
